...
const LoginForm = ({ onLogin }: LoginFormProps) => {
    ...
    return (
        <div className="bg-white w-[50%] login-form-content rounded-[32px]">
            <div className="flex items-center flex-col p-4">
                ...
                <div className="flex flex-col w-[67%] items-center">
                    ...
                    <Form onFinish={onFinish} layout="vertical" className="ant-form-container w-full">
                        <Form.Item
                            name="account"
                            label="Username"
                            rules={[
                        ...
                        <Form.Item {...buttonItemLayout}>
                            <Button
                                className="bg-[#002060] w-full mt-6 rounded-xl h-12 text-lg font-semibold text-white text-family button-ant_login"
                                type="primary"
                                htmlType="submit"
                            >
                                Sign in
